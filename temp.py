...
while True:
    ...
    sprite_draw_pos = Vector([sprite_pos[0]-w/2, sprite_pos[1]-h/2])
    ...
    sprite_rotation += rotation_direction * \
        sprite_rotation_speed * time_passed_seconds
    ...
    size = rotated_sprite.get_size()
    rect = Rect(sprite_draw_pos, size)
